...
var incompleteTaskHolder=document.getElementById("in-complete-tasks-list");//ul of #incompleteTasks
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("in-complete-tasks-item");
    ...
    listItem.classList.toggle("in-complete-tasks-item");
};
